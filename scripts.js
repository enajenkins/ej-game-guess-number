...
const resetBtn = document.querySelector("#resetBtn"); // EJ
const instructions = document.querySelector("#instructions");

startBtn.addEventListener("click", tryGuess);
// resetBtn.addEventListener("click", resetGame); // EJ
...
function tryGuess(){ 
    resetBtn.style.display = "none"; // EJ
...
function isGuessCorrect(correct) {
    ...
    if (correct) {
        ...
        resetBtn.style.display = "inline-block";  // EJ    
    } else {
